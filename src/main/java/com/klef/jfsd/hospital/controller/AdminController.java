...
public class AdminController 
{
  ...
  @GetMapping("viewallpr")
  public List<Pharmacist>viewallpharmacist()
  {
    return adminservice.displayallPharmacist();
  }
  ...
  @GetMapping("displaypt")
  public Pharmacist diplaypharmacistbyid(@RequestParam("id") int ptid)
  {
    return adminservice.displayPharmacistByID(ptid);
  }
